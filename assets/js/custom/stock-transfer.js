...
function stockTransfer(data){
    ...
    $.ajax({ 
		...
		data: {location_id:data.location_id,item_id:data.item_id,stock_qty:data.stock_qty,batch_no:data.batch_no}
...
function reportTable()
{
	var reportTable = $('#reportTable').DataTable( 
	{
		...
		buttons: [ 'pageLength', 'excel', {text: 'Refresh',action: function ( e, dt, node, config ) {loadItems();}}]
	});
