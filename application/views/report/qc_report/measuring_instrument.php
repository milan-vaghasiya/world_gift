                            ...
                            <table id='reportTable' class="table table-bordered">
								<thead class="thead-info" id="theadData">
                                    <tr class="text-center">
                                        <th colspan="7">Measuring Devices (Instruments/Equipments)</th>
                                        <th colspan="2">Doc. No.: D QA 02</th>
                                        <th colspan="2">Rev. No.& Dt.: 00/01-06-20</th>
                                    </tr>
									<tr class="text-center">
										<th rowspan="2">#</th>
										<th rowspan="2">Description of Instrument</th>
										<th rowspan="2">Inst. Code No.</th>
										<th rowspan="2">Make</th>
										<th rowspan="2">Range(mm)</th>
										<th rowspan="2">Least Count</th>
										<th rowspan="2">Permissible Error</th>
								...
								<tbody>
									<?php $i=1; 
									foreach($instrumentsData as $row):
										echo '<tr>
											<td>'.$i++.'</td>
											<td>'.$row->item_name.'</td>
											<td>'.$row->item_code.'</td>
											<td>'.$row->make_brand.'</td>
											<td>'.$row->instrument_range.'</td>
											<td></td>
											<td>'.$row->permissible_error.'</td>
