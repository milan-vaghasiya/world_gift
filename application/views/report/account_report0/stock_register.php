                        ...
                        <div class="table-responsive">
                            <table id='reportTable' class="table table-bordered">
								<thead class="thead-info" id="theadData">
                                    <tr class="text-center"><th colspan="9"><?=$pageHeader?></th></tr>
									<tr>
										<th style="min-width:25px;">Action</th>
										<th style="min-width:25px;">#</th>
										<th style="min-width:80px;">Product Name</th>
										<th style="min-width:50px;">Unit</th>
										<th style="min-width:100px;">Opning Stock</th>
										<th style="min-width:50px;">Opning Amount</th>
										<th style="min-width:50px;">Recived Stock</th>
										<th style="min-width:50px;">Recived Amount</th>
										<th style="min-width:50px;">Issue Stock</th>
...
/*function reportTable()
{
	...
	$('#reportTable').DataTable().columns.adjust();
	return reportTable;
}*/
</script>