                            ...
                            <table id='reportTable' class="table table-bordered">
								<thead class="thead-info" id="theadData">
									<tr>
										...
										<th style="min-width:80px;">Production Time <br><small>(In Min.)</small></th>
										<th style="min-width:80px;">Cycle Time <br><small>(In Min.)</small></th>
										<th style="min-width:80px;">Plan Qty.</th>
										<th style="min-width:80px;">Production Qty.</th>
                                        <th style="min-width:80px;">Productivity(%)</th>
                                    </tr>
								</thead>
...
$(document).ready(function(){
    ...
    $(document).on('click','.loaddata',function(e){
		...
		if($("#emp_id").val() == ""){$(".emp_id").html("Operator is required.");valid=0;}
		if($("#from_date").val() == ""){$(".fromDate").html("From Date is required.");valid=0;}
		if($("#to_date").val() == ""){$(".toDate").html("To Date is required.");valid=0;}
		if(valid)
		{
            $.ajax({
                url: base_url + controller + '/getOperatorPerformance',
