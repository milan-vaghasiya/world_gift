                            ...
                            <table id='reportTable' class="table table-bordered">
								<thead class="thead-info" id="theadData">
									...
									<tr>
										...
										<th style="min-width:50px;">Invoice Price</th>
										<th style="min-width:50px;">Invoice QTY</th>
										<th style="min-width:50px;">RFD QTY</th>
										<th style="min-width:50px;">Total QTY</th>
										<th style="min-width:80px;">Invoice Value</th>
										<th style="min-width:50px;">RFD Value</th>
...
$(document).ready(function(){
    ...
    $(document).on('click','.loaddata',function(e){
		...
		{
            $.ajax({
                url: base_url + controller + '/getPackingPlan',
