<form>
    <div class="col-md-12">
        <div class="row">
            ...
            <!-- <div class="col-md-6 form-group">
                <label for="production_hour">Production Hour</label>
                <input type="text" name="production_hour" class="form-control floatOnly req" value="<?=(!empty($dataRow->production_hour))?$dataRow->production_hour:""; ?>" />
            </div>
            <div class="col-md-6 form-group">
                <label for="lunch_hour">Lunch Hour</label>
                <input type="text" name="lunch_hour" class="form-control floatOnly req" value="<?=(!empty($dataRow->lunch_hour))?$dataRow->lunch_hour:""; ?>" />
            </div> -->
        </div>
    </div>
</form>