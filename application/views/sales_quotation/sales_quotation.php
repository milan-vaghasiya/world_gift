		...
		<div class="row">
			...
			<div class="col-md-3">
				...
				<div class="input-group mb-3">
					<input type="text" name="quote_prefix" class="form-control req" value="<?=(!empty($dataRow->quote_prefix))?$dataRow->quote_prefix:$quote_prefix?>" readonly />
					<input type="text" name="quote_no" class="form-control" value="<?=(!empty($dataRow->quote_no))?$dataRow->quote_no:$quote_no?>" readonly />
				</div>
			</div>

			<div class="col-md-3">
				<label for="quotation_date">Quotation Date</label>
				<input type="date" id="quotation_date" name="quotation_date" class=" form-control req" placeholder="dd-mm-yyyy" aria-describedby="basic-addon2" value="<?=(!empty($dataRow->quotation_date))?$dataRow->quotation_date:date("Y-m-d")?>" />	
			</div>
