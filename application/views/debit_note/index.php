                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="<?=base_url($headData->controller."/addDebitNote")?>" class="btn waves-effect waves-light btn-outline-primary float-right"><i class="fa fa-plus"></i> Add Debit Note</a>
                            </div>                             
                        </div>                                         
                    </div>
                    <div class="card-body">
