<form>
    <div class="col-md-12">
        <div class="row">
            ...
            <input type="hidden" name="entry_type" id="entry_type" value="16" />
            ...
            <div class="col-md-4 form-group">
                ...
                <select name="ref_by" id="ref_by" class="form-control single-select">
                    <option value="">Select Employee</option>
                    <?php
                        foreach($empData as $row):
                            $selected = ($row->id == $dataRow->ref_by) ? "selected":"";                            
