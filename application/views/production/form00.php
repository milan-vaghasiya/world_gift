    ...
    <div class="modal-dialog modal-lg" role="document" style="max-width:90%;">
        <div class="modal-content animated slideDown">
            ...
            <div class="modal-body jpFWTab">
				...
				<div class="col-md-12">
					<div class="row">
						<div class="col-md-4 form-group shiftDiv">
						...
						<div class="col-md-4 form-group operatorDiv">
						...
						<div class="col-md-4 form-group machineDiv">
					...
					<div id="IdleTime" class="tab-pane fade">
						<div class="col-md-12">
							<div class="row">									
								...
								<div class="col-md-4 form-group">
									<label for="breck_type">Breck Down Type</label>
									<select name="breck_type" id="breck_type" class="form-control single-select req">
										<option value="">Select Breck Down Type</option>
										<option value="0">Machine Breck</option>
										<option value="1">Other Breck</option>
									</select>
								</div>
