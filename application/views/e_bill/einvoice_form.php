    ...
    <div class="col-md-12 form-group">
        <div class="row">
            ...
            <div class="col-md-3 form-group">
                ...
                <input type="text" name="transport_name" id="transport_name" class="form-control" value="">
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3 form-group">
                ...
                <input type="text" name="billing_pincode" id="billing_pincode" class="form-control req" data-billing_pincode="<?=((!empty($partyData->party_pincode))?$partyData->party_pincode:"")?>" value="<?=(!empty($partyData->party_pincode))?$partyData->party_pincode:""?>" />
            </div>
            <div class="col-md-12 form-group">
                <label for="billing_address">Billing Address</label>
                <input type="text" name="billing_address" id="billing_address" class="form-control req" value="<?=(!empty($partyData->party_address))?$partyData->party_address:""?>" />
            </div>
            ...
            <div class="col-md-3 form-group">
                ...
                <input type="text" name="ship_pincode" id="ship_pincode" class="form-control req" data-ship_pincode="<?=((!empty($partyData->delivery_pincode))?$partyData->delivery_pincode:"")?>" value="<?=((!empty($partyData->delivery_pincode))?$partyData->delivery_pincode:"")?>" />
            </div>            
            
            <div class="col-md-12 form-group">
                <label for="ship_address">Shipping Address</label>
                <input type="text" name="ship_address" id="ship_address" class="form-control req" value="<?=(!empty($partyData->delivery_address))?$partyData->delivery_address:""?>" />
            </div>            
        </div>
    </div>
</form>