    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-4 form-group">
                ...
                <input type="text" name="trans_distance" id="trans_distance" class="form-control numericOnly req" min="0" maxlength="4" value="<?=(!empty(floatVal($distance)))?floatVal($distance):""?>" />
            </div>            
            <div class="col-md-4 form-group">
                <label>Transporter Name</label>
                <select name="transport_name" id="transport_name" class="form-control single-select transport_name req">
            ...
            <div class="col-md-2 form-group">											
                ...
                <select name="from_state" id="from_state" class="form-control single-select">                
                    <?php                    
                        echo $stateList['result'];                    
                    ?>
                </select>
                <div class="error from_state"></div>
            </div>
            <div class="col-md-2 form-group">
                <label for="from_state">Dispatch City</label>
                <select name="from_city" id="from_city" class="form-control single-select">
            ...
            <div class="col-md-2 form-group">                
                ...
                <select name="ship_state" id="ship_state" class="form-control single-select">                
                    <?php                    
                        echo $stateList['result'];                    
                    ?>
                </select>
            ...
            <div class="col-md-2 form-group">
                ...
                <select name="ship_city" id="ship_city" class="form-control single-select">
                <option value="">Select City</option>                    
