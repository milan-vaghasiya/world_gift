    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-6 form-group">
                ...
                <select name="default" id="default" data-input_id="default" class="form-control single-select">
					<option value="0" <?=(!empty($dataRow) && $dataRow->default == 0)?"selected":""?>>No</option>
					<option value="1" <?=(!empty($dataRow) && $dataRow->default == 1)?"selected":""?>>Yes</option>
                </select>
            </div>
        </div>
    </div>
