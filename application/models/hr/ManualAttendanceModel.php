...
class ManualAttendanceModel extends MasterModel{
    ...
    public function getDTRows($data){
		...
		$columns =array('','','emp_name','punch_in','remark');
    ...
    public function save($data){
        return $this->store($this->empAttendance,$data,'Manual Attendance');
    }

    public function delete($id){
        return $this->trash($this->empAttendance,['id'=>$id],'Manual Attendance');
    }
}
?>